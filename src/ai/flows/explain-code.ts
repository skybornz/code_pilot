...
const explainCodeFlow = ai.defineFlow(
  ...
  async (input) => {
    const {output} = await ai.generate({
        ...
        prompt: `You are an expert software developer who provides code explanations in a structured JSON format. Your output MUST be a valid JSON object matching the requested schema.
